...
const backimg = {
    fimg: '/static/Assets/IMG/Parkour.png',
    simg: '/static/Assets/IMG/PortadaParkour.png',
    timg: '/static/Assets/IMG/PortadaParkour2.png',
}


const slider_load = (index) => {
    const images = [backimg.fimg, backimg.simg, backimg.timg]
    const titles = ["Libertad en movimiento en la ciudad.", "Explora la creatividad en cada salto.", "Adrenalina en las calles de 'StreetFlow'."]
